...
>
> - **STATE-CLAIM 2026-09-19:** `origin/frontend-rebuild` = `7474b6c` (verified by `git rev-parse refs/remotes/origin/frontend-rebuild` after the desktop density release, commit 7474b6c deployed as parlay-b0bqm39lg).
