...
>
> - **STATE-CLAIM 2026-09-19:** `origin/frontend-rebuild` = `7ee44f2` (verified after the Phase 1 push; production /api/version returned this app commit, deployed as parlay-yzb99bcwj).
