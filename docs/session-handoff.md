...
>
> - **STATE-CLAIM 2026-09-18:** `origin/frontend-rebuild` = `da40781` (verified by `git rev-parse refs/remotes/origin/frontend-rebuild` after the one-per-team release, commit da40781 deployed as parlay-7lozeyhqh).
