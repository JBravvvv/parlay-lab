...
>
> - **STATE-CLAIM 2026-09-17:** `origin/frontend-rebuild` = `504e241` (verified by `git rev-parse refs/remotes/origin/frontend-rebuild` after the backdrop-colour release, deployed as parlay-dwv67ilwt).
