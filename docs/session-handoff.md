...
>
> - **STATE-CLAIM 2026-09-18:** `origin/frontend-rebuild` = `0819dcd` (verified by `git rev-parse refs/remotes/origin/frontend-rebuild` after the pink-brand release, deployed as parlay-luqnxhok8).
