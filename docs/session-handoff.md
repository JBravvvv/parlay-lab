...
>
> - **STATE-CLAIM 2026-09-05:** `origin/frontend-rebuild` = `5fd7c14def3f512444ec12fab2e15a82a9e05393` (restated 2026-09-05 after instruction 37 shipped and before instruction 38 was committed; the 2026-09-04 claim is history.)
...
| doc | what it holds |
|---|---|
| `cfb-desk.md` | the College Football desk reference: model constants, pricing pipeline, team-alias table, card and fun-parlay rules, every separate key/route/store, tests and fixtures, known dev-only behaviours |
