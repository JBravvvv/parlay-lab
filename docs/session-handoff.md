...
>
> - **STATE-CLAIM 2026-09-18:** `origin/frontend-rebuild` = `1c9c990` (verified by `git rev-parse refs/remotes/origin/frontend-rebuild` after the eight-item UI pass release, commit 1c9c990 deployed as parlay-evq9gozv4).
