...
13. **THE $150 ACTUALLY DEPLOYS (added 2026-08-19, same day — verbatim: "There is only
    ...
    (`decideTopUp` → `generate?topup=1`, fresh prices, TOPUP_MAX 4/day registry-capped since INSTRUCTION 48 (was 2),
...
- ODDS CREDITS (real money; the paper is hypothetical). MLB run 114–150 credits; football lines pull 6; ticker 48 pokes/day (every 15 min, UTC 15–23 and 0–2 — `docs/cron-jobs.md`, UNCHANGED, Josh's cron-job.org account; the last MLB sweep chance of a date is the 02:45Z poke).
