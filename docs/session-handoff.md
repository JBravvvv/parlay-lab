...
>
> - **STATE-CLAIM 2026-09-17:** `origin/frontend-rebuild` = `6098fdd` (verified by `git rev-parse refs/remotes/origin/frontend-rebuild` before the backdrop-colour release).
