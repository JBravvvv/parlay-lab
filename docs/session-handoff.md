...
>
> - **STATE-CLAIM 2026-09-18:** `origin/frontend-rebuild` = `ade259c` (verified by `git rev-parse refs/remotes/origin/frontend-rebuild` after the UI-overhaul release, deployed as parlay-mih5dl0t0).
