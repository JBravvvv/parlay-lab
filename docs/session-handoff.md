...
| doc | what it holds |
|---|---|
| `cfb-desk.md` | the College Football desk reference: model constants, pricing pipeline, team-alias table, card and fun-parlay rules, player props and the picks / parlay tiers, the iOS freeze fix, the props quota cap, every separate key/route/store, tests and fixtures, known dev-only behaviours |
