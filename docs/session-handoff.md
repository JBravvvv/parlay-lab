...
- Grading cadence: `GRADE_HOURS = [15, 18, 22, 2]` UTC (was 15/2) — four passes, all inside the cron-job.org poke window (15–23, 0–2 UTC). Hours outside the window can never fire; widening is Josh's cron-job.org call.
