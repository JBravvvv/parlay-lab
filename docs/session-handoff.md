...
>
> - **STATE-CLAIM 2026-09-17:** `origin/frontend-rebuild` = `e5fa8f1` (verified by `git rev-parse refs/remotes/origin/frontend-rebuild` before the DraftKings settlement-book release).
