...
>
> - **STATE-CLAIM 2026-09-17:** `origin/frontend-rebuild` = `602ba08` (verified by `git rev-parse refs/remotes/origin/frontend-rebuild` before the Ballpark Factor / sort / marks / parlay-variety release).
