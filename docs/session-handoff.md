...
>
> - **STATE-CLAIM 2026-09-19:** `origin/frontend-rebuild` = `943d804` (verified by `git rev-parse refs/remotes/origin/frontend-rebuild` after the phone-density release, commit 943d804 deployed as parlay-4a9npa21b).
