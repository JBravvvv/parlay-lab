 ...
 *   A ≥ +3 · B ≥ +1 · C ≥ −1 (about fair) · D ≥ −3 · F below −3.
...
export const GRADE_CUTS = { A: 3, B: 1, C: -1, D: -3 } as const;
...
/** Sort key: A first. Ungraded (null) sorts last. */
export function gradeRank(g: Grade | null): number {
  return g === "A" ? 5 : g === "B" ? 4 : g === "C" ? 3 : g === "D" ? 2 : g === "F" ? 1 : 0;
}
