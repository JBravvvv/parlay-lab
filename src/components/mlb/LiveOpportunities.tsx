...
export function LiveOpportunities({games,market,search,loading,syncReady,error}:{games:PropBoardGame[];market:string;search:string;loading:boolean;syncReady:boolean;error:string|null}){
