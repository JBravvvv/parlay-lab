...
export function DiscoveryFilters({value,onChange,markets,showSports=true}:{value:DiscoveryFilter;onChange:(v:DiscoveryFilter)=>void;markets:readonly {key:string;label:string}[];showSports?:boolean}) {
 ...
 <MultiSelect label="Style" options={STRATEGIES} value={value.strategies} onChange={strategies=>onChange({...value,strategies})}/>
