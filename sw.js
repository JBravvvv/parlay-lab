...
self.addEventListener('fetch', (event) => {
  ...
  // Only manage our own origin. Live data (MLB Stats API, The Odds API), ESPN
  // logos and Google Fonts go straight to the network and fail gracefully offline.
