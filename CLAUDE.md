...
| `docs/multibook-memo.md` | **the multi-book scoping memo (2026-07-28, corrected same day)**: feed census (only BetMGM of five targets; DK/FD NOT playable from NV — verified); THE PLAYABLE PRIZE **+1.01 pp/leg / +1.60 pp per 3-leg slip** (one book per slip), 44%/51% improved — dispersion, not a better book; Circa one-paste-day spec with the CLV cost priced into the same decision; sb schema; freeze posture execution-change |
